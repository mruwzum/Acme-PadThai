...
<display:table name="user" id="row" requestURI="http://localhost:8080/anonymus/others.do" pagesize="10"
               class="displaytag">
...
<display:table name="nutritionist" id="row" requestURI="http://localhost:8080/anonymus/others.do" pagesize="10"
               class="displaytag">
    ...
    <display:column title="${profileHeader}">
        <a href="anonymus/nutritionistProfile.do?userID=${row.id}">
            <spring:message code="user.profile"/>
        </a>
    </display:column>
...
<input type="button" name="back"
       ...
       onclick="window.location.replace('anonymus/others.do')"/>